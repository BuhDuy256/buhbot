...
7. API Documentation: @"docs/api/api-map.md" — Contains a map of all API documentation (Zendesk, OpenAI Vector Store). AI needs to read this file first to have the map, and after that search if needed.
